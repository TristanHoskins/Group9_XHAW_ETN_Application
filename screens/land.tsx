...
type landScreenProp = StackNavigationProp< RootStackParamList,'Land'>;

export default function landScreen() {
  const navigation = useNavigation<landScreenProp>();
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Month')}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.blueSection}>
            <Text style={styles.blueSectionText}>Land Scaping</Text>
          </View>
          <View style={styles.grayLineThin} />
          <View style={styles.grayLine}>
            <Text style={styles.grayLineText}>
            Landscaping combines creativity and environmental knowledge to design aesthetically
                    pleasing and sustainable outdoor spaces. It improves the value and functionality of properties, from
                    homes to commercial spaces. Understanding landscaping techniques also contributes to eco-friendly
                    practices, such as water conservation and the use of native plants.
            </Text>
          </View>
          <View style={styles.grayLine} />
          <Image source={require('./img/landh.jpg')} style={styles.heroShot} />
          ...
          <View style={styles.courseContentSection}>
            ...
            <Text style={styles.courseFees}>
              ...
              <Text style={{ fontWeight: 'bold', fontSize: 22 }}>Purpose:</Text> To provide landscaping services for new and established gardens
            </Text>
          ...
          <View style={styles.courseOpportunitiesSection}>
            ...
            <Text style={styles.courseFees}>
            There is a growing demand for garden maintenance, as more people move into homes with gardens but lack the time and knowledge to care for and maintain them.
            </Text>
            <Text style={{ fontWeight: 'bold', fontSize: 20 }}>Successfully completing the course qualifies you to be a:</Text>
            <View style={styles.contentList}>
              <Text style={styles.listItem}>• Lawn care specialist</Text>
              <Text style={styles.listItem}>• Groundskeeper</Text>
              <Text style={styles.listItem}>• Landscape Architect</Text>
            </View>
          </View>
          ...
          <View style={styles.testimonials}>
            <View style={styles.testimonial}>
              <Image
                source={require('./img/landscaping1.jpg')}
                style={styles.testimonialImg}
              />
              <Text style={styles.testimonialName}>Themba Khumalo</Text>
              <Text style={styles.testimonialDescription}>
              Sandton - Qualifications: Diploma in Landscape Design, Horticulture Certification. - Experience:
                        12 years of experience in landscape architecture, specializing in sustainable and indigenous
                        gardening.
              </Text>
            </View>
            <View style={styles.testimonial}>
              <Image
                source={require('./img/landscaping 2.png')}
                style={styles.testimonialImg}
              />
              <Text style={styles.testimonialName}>Sarah Richard </Text>
              <Text style={styles.testimonialDescription}>
              Pretoria - Certificate in Landscaping and Garden Maintenance. - Experience: 9 years of
                        experience in creating eco-friendly outdoor spaces and training others in landscape maintenance.
              </Text>
            </View>
            <View style={styles.testimonial}>
              <Image
                ...
                style={styles.testimonialImg}
              />
              <Text style={styles.testimonialName}>Kagiso Mbele</Text>
              <Text style={styles.testimonialDescription}>
              Johannesburg - Qualifications: National Diploma in Horticulture, Landscaping Professional
                        Certification. - Experience: 10 years working with corporate landscaping projects and training
                        gardeners in modern landscaping techniques.
              </Text>
            </View>
          </View>
