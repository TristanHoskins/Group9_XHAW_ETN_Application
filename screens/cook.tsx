...
type cookScreenProp = StackNavigationProp< RootStackParamList,'cook'>;

export default function cookScreen() {
  const navigation = useNavigation<cookScreenProp>();
  return (
      ...
      <TouchableOpacity onPress={() => navigation.navigate('week')}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.grayLine}>
            ...
            Cooking is a vital life skill that ensures self-sufficiency, nutrition, and
                    cost-effective meal preparation. Knowledge of cooking techniques allows individuals to make
                    healthier food choices and reduce reliance on processed or fast food. It also offers entrepreneurial
                    opportunities in catering or home-based food businesses.
            </Text>
          </View>
          <View style={styles.grayLine} />
          <Image source={require('./img/cookingh.png')} style={styles.heroShot} />
          ...
          <View style={styles.courseContentSection}>
            ...
            <Text style={styles.courseFees}>
              ...
              <Text style={{ fontWeight: 'bold', fontSize: 22 }}>Purpose:</Text>  To prepare and cook nutritious family meals
            </Text>
          ...
          <View style={styles.courseOpportunitiesSection}>
            ...
            <Text style={styles.courseFees}>
            This course takes you on a culinary journey to greatness, providing skills that can be utilized in the kitchen and the job.
            </Text>
            <Text style={{ fontWeight: 'bold', fontSize: 20 }}>Successfully completing the course qualifies you to be a:</Text>
            <View style={styles.contentList}>
              <Text style={styles.listItem}>• Food Stylist</Text>
              <Text style={styles.listItem}>• Caterer</Text>
              <Text style={styles.listItem}>• Host of a Cooking Studio</Text>
            </View>
          </View>
          ...
          <View style={styles.testimonials}>
            <View style={styles.testimonial}>
              <Image
                source={require('./img/cook1.jpg')}
                style={styles.testimonialImg}
              />
              <Text style={styles.testimonialName}>Chef Lebo Thwala</Text>
              <Text style={styles.testimonialDescription}>
              Sandton - Qualifications: Diploma in Culinary Arts, Professional Chef Certification. -
                        Experience: 15 years of experience in the restaurant industry, with 5 years as a cooking
                        instructor for beginners
              </Text>
            </View>
            <View style={styles.testimonial}>
              <Image
                source={require('./img/cook2.jpg')}
                style={styles.testimonialImg}
              />
              <Text style={styles.testimonialName}>Brenda van der Merwe</Text>
              <Text style={styles.testimonialDescription}>
              Johannesburg - Qualifications: Certified Culinary Instructor - Experience: 10 years of experience
                        working in professional kitchens and teaching home-cooking and catering skills.
              </Text>
            </View>
            <View style={styles.testimonial}>
              <Image
                source={require('./img/cook3.jpg')}
                style={styles.testimonialImg}
              />
              <Text style={styles.testimonialName}>Chef Simphiwe Mazibuko</Text>
              <Text style={styles.testimonialDescription}>
              Qualifications: Diploma in Catering, Food Safety Certification. - Experience: 8 years working as
                        a sous chef and 5 years running cooking workshops for domestic workers and small business
                        owners.
              </Text>
            </View>
          </View>
